...
`;
  ...
  const markdownToShow =
    generatedMarkdown && generatedMarkdown.length > 10
      ? generatedMarkdown
      : fallbackMarkdown;
        ...
        <div className="flex flex-wrap items-center gap-2 justify-end">
          ...
          <div className="flex bg-slate-800 rounded-lg overflow-hidden text-xs">
            <button
              ...
              className={`px-3 py-1 ${mode === "preview"
          ...
          <button
            onClick={handleCopy}
            className="text-[10px] sm:text-xs bg-slate-800 hover:bg-slate-700 px-2 sm:px-3 py-1 rounded-lg text-white"
          >
            {copied ? "Copied!" : "Copy"}
          </button>
          ...
          <button
            ...
            className="text-[10px] sm:text-xs bg-indigo-500 hover:bg-indigo-400 px-2 sm:px-3 py-1 rounded-lg text-white"
          >
            Download
          </button>
